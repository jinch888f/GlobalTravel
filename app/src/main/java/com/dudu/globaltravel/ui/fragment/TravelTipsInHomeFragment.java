...
import com.dudu.globaltravel.adapter.TravelTipsInHomeListAdapter;
...
public class TravelTipsInHomeFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_DATAGETSUCCESS:
                    ...
                    mRecyclerView.setAdapter(new TravelTipsInHomeListAdapter(getActivity(),mModels));
                    break;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        mRecyclerView = (RecyclerView) inflater.inflate(R.layout.fg_traveltipsinhome,parent,false);
